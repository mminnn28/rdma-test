 ...
 * client(active) code
 * 
 * https://www.digitalvampire.org/rdma-tutorial-2007/notes.pdf
 * 
...
#include <rdma/rdma cma.h>      // a communication manager (CM) - set up reliable, connected, and unreliable datagram data transfers and control both the QP and communication management
...
int main(int argc, char *argv[]) {
    ...
    struct ibv_send_wr *bad_recv_wr;
    ...
    cm_channel = rdma_crete_event_channel();
    if (!cm_channel)
        return 1;
